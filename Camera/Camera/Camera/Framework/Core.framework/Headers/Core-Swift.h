...
SWIFT_CLASS("_TtC4Core14AnalyticsAgent")
...
SWIFT_CLASS("_TtC4Core11BaseService")
...
SWIFT_CLASS("_TtC4Core18BaseViewController")
...
SWIFT_CLASS("_TtC4Core13ConfiguredEnv")
@interface ConfiguredEnv : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nonnull environment;)
+ (NSString * _Nonnull)environment;
+ (void)setEnvironment:(NSString * _Nonnull)newValue;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull baseUrl;)
+ (NSString * _Nonnull)baseUrl;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull baseApiUrl;)
+ (NSString * _Nonnull)baseApiUrl;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull baseVerApiUrl;)
+ (NSString * _Nonnull)baseVerApiUrl;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull baseVersionedApiUrl;)
+ (NSString * _Nonnull)baseVersionedApiUrl;
...
SWIFT_CLASS("_TtC4Core14NetworkManager")
...
SWIFT_CLASS("_TtC4Core14ProgressButton")
...
SWIFT_CLASS("_TtC4Core12ServiceAgent")
@interface ServiceAgent : NSObject <NSURLSessionDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


@interface UIButton (SWIFT_EXTENSION(Core))
@end


@interface UIColor (SWIFT_EXTENSION(Core))
@end


@interface UIImage (SWIFT_EXTENSION(Core))
@end


@interface UIImageView (SWIFT_EXTENSION(Core))
@end


@interface UITextField (SWIFT_EXTENSION(Core))
@end
...
@interface UIWindow (SWIFT_EXTENSION(Core))
...
SWIFT_CLASS("_TtC4Core15UserPreferences")
