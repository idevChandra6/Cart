...
SWIFT_CLASS("_TtC7OMCCore7Address")
...
SWIFT_CLASS("_TtC7OMCCore8Attendee")
@interface Attendee : Contact
@property (nonatomic, copy) NSString * _Nullable title;
@property (nonatomic, copy) NSArray<Attendee *> * _Nullable companions;
@property (nonatomic) BOOL isCompanion;
@property (nonatomic, copy) NSString * _Nullable companionAttendeeUUID;
@property (nonatomic, copy) NSString * _Nullable attendeeUUID;
@property (nonatomic, copy) NSString * _Nullable createdAtDate;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)encodeWithCoder:(NSCoder * _Nonnull)aCoder;
- (nonnull instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC7OMCCore6Beacon")
@interface Beacon : NSObject
@property (nonatomic, copy) NSString * _Nullable id;
@property (nonatomic, copy) NSString * _Nullable name;
@property (nonatomic, strong) CLBeaconRegion * _Nullable beaconRegion;
@property (nonatomic) NSTimeInterval waitTimeIntervalInSec;
@property (nonatomic, copy) NSString * _Nullable locationId;
@property (nonatomic) BOOL canCollectBeaconInfo;
@property (nonatomic, copy) NSString * _Nullable userId;
@property (nonatomic, copy) NSDate * _Nullable dateTimeEntered;
@property (nonatomic, copy) NSDate * _Nullable dateTimeExited;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) BOOL isMockServiceEnabled;)
+ (BOOL)isMockServiceEnabled;
@end
...
SWIFT_CLASS("_TtC7OMCCore8Location")
...
@property (nonatomic, copy) NSString * _Nullable addressStr;
...
@property (nonatomic, readonly, copy) NSString * _Nullable cityStateZipcode;
...
SWIFT_CLASS("_TtC7OMCCore16MockServiceAgent")
@interface MockServiceAgent : ServiceAgent
...
+ (UIColor * _Nullable)colorWithHexString:(NSString * _Nonnull)hexString alpha:(float)alpha;
@end
...
+ (void)roundImageView:(UIView * _Nonnull)imageView;
@end
...
@property (nonatomic, copy) NSString * _Nullable accessToken;
@property (nonatomic, strong) Beacon * _Nullable transmittingBeacon;
